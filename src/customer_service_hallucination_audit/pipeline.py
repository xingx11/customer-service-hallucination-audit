...
from customer_service_hallucination_audit.metrics import analyze_errors, calculate_metrics
from customer_service_hallucination_audit.models import DetectionResult, ErrorCase, MetricsSummary
...
def run_audit(
    *,
    ...
    markdown_path.write_text(
        render_markdown_report(results, metrics, error_cases),
        encoding="utf-8",
    )
    json_path.write_text(
        render_json_report(results, metrics, error_cases),
        encoding="utf-8",
    )
